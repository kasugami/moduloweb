...
public class EncryptionServiceImp implements EncryptionService {
    ...
    public final String encrypt(final String text) {
        String secretKey = "mikekIsJCSC"; //llave para encriptar datos
...
//             MessageDigest md = MessageDigest.getInstance("MD5");
    ...
    @Override
    public final String desencrypt(String text) {
        String secretKey = "mikekIsJCSC"; //llave para desenciptar datos
        String base64EncryptedString = "";
